...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('dim_kunjungan_detail', function (Blueprint $table) {
    ...
    {
        Schema::connection($this->connection)->dropIfExists('dim_kunjungan_detail');
    }
};
