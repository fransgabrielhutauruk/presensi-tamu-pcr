...
(function ($, document, window) {
    ...
    Plugin.prototype.init = function () {
        ...
        $(".navbar-toggle-responsive").append($this.btn.clone(true));
        ...
        // // menu button clone click
        // $(".navbar-toggle-responsive").click(function (e) {
        //     e.preventDefault();
        //     $this._menuToggle();
        // });

        // After creating both buttons:
        $this.btns = $($this.btn).add(
            $(".navbar-toggle-responsive").find("." + prefix + "_btn")
        );
    ...
    Plugin.prototype._menuToggle = function (el) {
        ...
        if (btns.hasClass(prefix + "_collapsed")) {
            btns.removeClass(prefix + "_collapsed");
            btns.addClass(prefix + "_open");
        } else {
            btns.removeClass(prefix + "_open");
            btns.addClass(prefix + "_collapsed");
        }

        btns.addClass(prefix + "_animating");
        $this._visibilityToggle(mobileNav, btns.parent(), true, btns);
    };
