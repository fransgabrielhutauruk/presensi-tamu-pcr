...
<head>
    ...
    <title>Sudah Checkout - PCR</title>
                ...
                <div class="card">
                    <div class="card-body p-5 text-center">
                        <div class="mb-4">
                            ...
                            <h2 class="text-info mb-2">Sudah Checkout</h2>
                            <p class="text-muted">Anda telah melakukan checkout sebelumnya</p>
                        </div>
                        ...
                        <div class="alert alert-info" role="alert">
                            ...
                            Checkout telah dilakukan sebelumnya
                        </div>
