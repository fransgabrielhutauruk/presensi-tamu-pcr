...
@section('content')
    ...
    <div class="organization-page content-page">
        @include('contents.frontend.partials.main.profile.organization.structure')
        @include('contents.frontend.partials.common.container-divider')
        @include('contents.frontend.partials.main.profile.organization.profile')
    </div>
@endsection
