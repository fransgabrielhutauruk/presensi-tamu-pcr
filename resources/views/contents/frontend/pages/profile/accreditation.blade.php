...
@section('content')
    ...
    <div class="accreditation-page content-page">
        @include('contents.frontend.partials.main.profile.accreditation.content')
        @include('contents.frontend.partials.common.container-divider')
        @include('contents.frontend.partials.main.profile.accreditation.grid')
    </div>
@endsection
