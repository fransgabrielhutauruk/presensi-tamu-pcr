...
@push('scripts')
    ...
    <script>
        jForm.init({
            name: "post-kategori",
            url: {
                add: `{{ route('app.post.store', ['param1' => 'kategori']) }}`,
                edit: `{{ route('app.post.data', ['param1' => 'kategori-detail']) }}`,
                update: `{{ route('app.post.update', ['param1' => 'kategori']) }}`,
                delete: `{{ route('app.post.destroy', ['param1' => 'kategori']) }}`
            },
        })
    </script>
@endpush
