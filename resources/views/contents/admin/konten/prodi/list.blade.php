                    ...
                    <div class="d-flex w-100 flex-column rounded-4 border border-1 p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center justify-content-end my-6 gap-1">
                                <a class="btn btn-icon btn-sm mh-25px mw-25px btn-light-primary act-delete me-1" href="{{ url('admin/konten-prodi') }}/${full.id}"" title="Kelola Konten Situs"><i class="ki-outline ki-icon fs-3"></i></a>
                                <a class="btn btn-icon btn-sm mh-25px mw-25px btn-light-primary act-delete me-1" href="="{{ url('admin/konten-page/prodi-site/') }}/${full.id}"" title="Kelola Halaman Statis"><i class="ki-outline ki-menu fs-3"></i></a>
                            </div>
                        </div>
                        <div class="d-flex justify-content-start flex-column flex-grow-1 mt-4 fw-bold fs-5">
                                ${full.jenjang_pendidikan}-${full.nama_prodi}
                            <div class="d-flex flex-row fs-8 align-items-center">
                                <a href="${full.url_prodi}" target="_blank">
                                    <div class="d-flex flex-row align-items-center">
                                        ${full.url_prodi}<i class="bi bi-box-arrow-up-right fs-9 ms-1 text-primary"></i>
                                    </div>
                                </a>
                            </div>
                        </div>
