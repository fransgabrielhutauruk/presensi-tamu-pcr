<x-form.textarea-field
    name="keperluan"
    :label="__('visitor.visit_purpose_label')"
    :placeholder="__('visitor.visit_purpose_placeholder')"
    required="true"
    rows="3" />

<x-form.input-field
    name="jumlah_rombongan"
    :label="__('visitor.group_size_label')"
    type="number"
    min="1"
    max="50"
    required="true"
...
<x-form.input-field
    name="waktu_keluar"
    :label="__('visitor.estimated_finish_time')"
    type="time"
    required="true" />

<x-form.select-field
    name="transportasi"
    :label="__('visitor.transportation_label')"
    required="true"
    :options="[
