...
class KaryaJenisController extends Controller
{
    ...
    function index()
    {
        $this->title        = 'Kelola Karya Jenis';
        $this->activeMenu   = 'karya-jenis';
        $this->breadCrump[] = ['title' => '', 'link' => url()->current()];

        $builder   = app('datatables.html');
        $dataTable = $builder->serverSide(true)->ajax(route('karya-jenis.data') . '/list')->columns([
        ...
        return $this->view('master.karya_jenis');
    }
