...
class EventController extends Controller
{
    ...
    public function show($param1 = '', $param2 = '')
    {
        ...
        } elseif ($param1 == 'validasi-kunjungan') {
    ...
    public function data(Request $req, $param1 = '', $param2 = ''): JsonResponse
    {
        if ($param1 == 'list') {
            ...
            return DataTables::of($query)
                ...
                ->filterColumn('lokasi_event', fn ($query, $keyword) => $query->where('event.lokasi_event', 'like', "%{$keyword}%"))
                ->filterColumn('tanggal_event', fn ($query, $keyword) => dtFilterByDateKeyword($query, $keyword, 'event.tanggal_event', 10))
        ...
        } elseif ($param1 == 'validasi-kunjungan-list') {
            $eventId = decid($param2);
            ...
            $dt = DataTables::of($query)
                ...
                ->filterColumn('identitas', fn ($query, $keyword) => $query->where('kunjungan.identitas', 'like', "%{$keyword}%"))
